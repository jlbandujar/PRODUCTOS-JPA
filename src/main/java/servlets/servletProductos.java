...
import com.mycompany.productos.Productos;
...
public class servletProductos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Productos> misProductos = getProductos();
...
//            for (  )
       ...
       public static List<Productos> getProductos() throws FileNotFoundException, IOException{
